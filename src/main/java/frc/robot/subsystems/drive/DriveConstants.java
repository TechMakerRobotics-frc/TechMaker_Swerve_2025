...
public class DriveConstants {
  ...
  public static class ZoneLocates {
    public static final Circle2d blueLeftStation =
        new Circle2d(1.100, 7.124, 2.6, Zones.BLUE_LEFT_STATION);
    public static final Circle2d blueRightStation =
        new Circle2d(1.100, 0.974, 2.6, Zones.BLUE_RIGHT_STATION);
    public static final Circle2d redLeftStation =
        new Circle2d(16.697198, 0.974, 2.6, Zones.RED_LEFT_STATION);
    public static final Circle2d redRightStation =
        new Circle2d(16.411, 6.968, 2.6, Zones.RED_RIGHT_STATION);
