...
public class TunerConstants {
        ...
        private static final Slot0Configs driveGains = new Slot0Configs().withKP(0.03).withKI(0).withKD(0).withKS(0)
                        .withKV(0.124);
        ...
        // This needs to be tuned to your individual robot
        public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(TunerConstants.maxSpeedMetersPerSec);
        ...
        private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.091553);
        private static final boolean kFrontLeftSteerMotorInverted = TunerConstants.turnInverted;
        private static final boolean kFrontLeftCANcoderInverted = TunerConstants.turnEncoderInverted;
        ...
        private static final Angle kFrontRightEncoderOffset = Rotations.of(0.324707);
        private static final boolean kFrontRightSteerMotorInverted = TunerConstants.turnInverted;
        private static final boolean kFrontRightCANcoderInverted = TunerConstants.turnEncoderInverted;
        ...
        private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.112549);
        private static final boolean kBackLeftSteerMotorInverted = TunerConstants.turnInverted;
        private static final boolean kBackLeftCANcoderInverted = TunerConstants.turnEncoderInverted;
        ...
        private static final Angle kBackRightEncoderOffset = Rotations.of(0.373047);
        private static final boolean kBackRightSteerMotorInverted = TunerConstants.turnInverted;
        private static final boolean kBackRightCANcoderInverted = TunerConstants.turnEncoderInverted;
