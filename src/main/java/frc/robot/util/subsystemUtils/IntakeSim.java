...
public class IntakeSim extends LinearSystemSim<N1, N1, N1> {
   ...
   *     LinearSystemId#createIntakeSystem(DCMotor, double, double)} if using physical constants or
   *     {@link LinearSystemId#identifyVelocitySystem(double, double)} if using system
   *     characterization.
