...
public class IntakeSim extends LinearSystemSim<N1, N1, N1> {
     ...
     *
     * @param plant The linear system that represents the Intake. Use either
     *     {@link LinearSystemId#createIntakeSystem(DCMotor, double, double)} if using physical constants or
     ...
     */
    public IntakeSim(LinearSystem<N1, N1, N1> plant, DCMotor gearbox, double... measurementStdDevs) {
