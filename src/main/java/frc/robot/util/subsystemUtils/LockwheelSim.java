...
public class LockwheelSim extends LinearSystemSim<N1, N1, N1> {
   ...
   *
   * @param plant The linear system that represents the Lockwheel. Use either {@link
   *     LinearSystemId#createLockwheelSystem(DCMotor, double, double)} if using physical constants
