...
/**
 * Utility class for interacting with an arcade-style joystick. This class maps joystick buttons to
 * `Trigger` objects and provides access to each button through dedicated methods.
 */
public class Arcade {
