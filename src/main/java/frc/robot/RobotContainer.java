...
public class RobotContainer {
  ...
  public RobotContainer() {
    switch (Constants.currentMode) {
      case REAL:
        ...
        vision =
            new Vision(
                drive,
                new VisionIOPhotonVision(FL_CAM_NAME, ROBOT_TO_FL_CAM),
    ...
    pathfinderTest = new LoggedDashboardChooser<>("Auto Reef Choices");
    ...
    pathfinderTest.addOption(
        "Station Blue Left", new DriveTo(drive, CoralStationPoses.LEFT_BLUE, 20));
    pathfinderTest.addOption(
        "Station Blue Right", new DriveTo(drive, CoralStationPoses.RIGHT_BLUE, 20));
    pathfinderTest.addOption(
        "Station Red Left", new DriveTo(drive, CoralStationPoses.LEFT_RED, 20));
    pathfinderTest.addOption(
        "Station Red Right", new DriveTo(drive, CoralStationPoses.RIGHT_RED, 20));
  ...
  private void configureButtonBindings() {
    ...
    new Trigger(
            () ->
                (currentState == RobotState.ON_BLUE_LEFT_STATION)
                    && (pathfinderTest.get().isFinished()))
        .whileTrue(
    ...
    new Trigger(
            () ->
                (currentState == RobotState.ON_BLUE_RIGHT_STATION)
                    && (pathfinderTest.get().isFinished()))
        .whileTrue(
            DriveCommands.joystickDriveAimAtPoint(
                drive,
    ...
    new Trigger(
            () ->
                (currentState == RobotState.ON_RED_LEFT_STATION)
                    && (pathfinderTest.get().isFinished()))
        .whileTrue(
    ...
    new Trigger(
            () ->
                (currentState == RobotState.ON_RED_RIGHT_STATION)
                    && (pathfinderTest.get().isFinished()))
        .whileTrue(
            DriveCommands.joystickDriveAimAtPoint(
                drive,
    ...
    new Trigger(
            () ->
                (currentState == RobotState.ON_BLUE_PROCESSOR)
                    && (pathfinderTest.get().isFinished()))
        .whileTrue(
            DriveCommands.joystickDriveAimAtPoint(
                drive,
    ...
    new Trigger(
            () ->
                (currentState == RobotState.ON_RED_PROCESSOR)
                    && (pathfinderTest.get().isFinished()))
        .whileTrue(
            DriveCommands.joystickDriveAimAtPoint(
                drive,
